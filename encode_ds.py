"""Write deep_search_streaming.py using base64 to avoid escaping issues."""

import base64

# The file content, properly formatted
...
# Encode and decode to write file
encoded = base64.b64encode(content.encode('utf-8'))
with open('deep_search_streaming.py', 'wb') as f:
    f.write(base64.b64decode(encoded))

print('deep_search_streaming.py written successfully')
