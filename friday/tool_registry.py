...
TOOL_META: Dict[str, dict] = {
    ...
    "vision_click": {"category": "vision", "risk": "local_write", "description": "Find UI element by description and click it. Uses vision + pywinauto with overlay animation."},
    "point_at": {"category": "vision", "risk": "read_only", "description": "Animate cursor buddy to screen coordinates with label"},
    ...
    "analyze_screen": {"category": "vision", "risk": "read_only", "description": "[NIM VISION] Tag all UI elements with [POINT:x,y:label] coordinates. FRIDAY uses these to annotate/narrate."},
    "show_pointer": {"category": "vision", "risk": "read_only", "description": "Animate cursor buddy to screen coordinates with label"},
    "show_cursor_hint": {"category": "vision", "risk": "read_only", "description": "Show speech bubble near buddy's current position"},
    "show_annotation_box": {"category": "vision", "risk": "read_only", "description": "Highlight screen region with dashed border box"},
    "show_draw_arrow": {"category": "vision", "risk": "read_only", "description": "Draw arrow from one screen coordinate to another"},
    "draw_line": {"category": "vision", "risk": "read_only", "description": "Draw animated line between two points, buddy follows along"},
    "draw_path": {"category": "vision", "risk": "read_only", "description": "Draw arbitrary SVG path on screen"},
    "draw_polygon": {"category": "vision", "risk": "read_only", "description": "Draw closed polygon from coordinate pairs"},
    "show_text": {"category": "vision", "risk": "read_only", "description": "Show text at screen coordinates"},
    "clear_overlays": {"category": "vision", "risk": "read_only", "description": "Clear all screen overlays, buddy returns to cursor-following"},
