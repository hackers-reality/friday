...
TOOL_DESCRIPTORS: list[tuple[str, str, str, dict | None, list[str] | None]] = [
    ...
    ("friday.tools.ai_tools", "openrouter_chat", "Chat with any model via OpenRouter (300+ models available)", {"model": {"type": "STRING", "description": "Model name (default google/gemini-2.5-flash-native-audio-preview-12-2025:free)"}, "messages": {"type": "ARRAY", "items": {"type": "OBJECT", "properties": {"role": {"type": "STRING", "description": "user or assistant"}, "content": {"type": "STRING", "description": "Message content"}}}, "description": "Chat messages array"}, "temperature": {"type": "NUMBER", "description": "Sampling temperature (default 0.7)"}}, ["messages"]),
    ...
    ("friday.google_clients", "analytics_batch_run_reports", "", None, None),
    ("friday.google_clients", "analytics_get_metadata", "", None, None),
    ("friday.google_clients", "analytics_get_realtime", "", None, None),
    ("friday.google_clients", "analytics_list_accounts", "Analytics List Accounts", {}, None),
    ("friday.google_clients", "analytics_list_properties", "", None, None),
    ("friday.google_clients", "analytics_run_report_expanded", "", None, None),
    ("friday.google_clients", "bigquery_get_dataset", "", None, None),
    ("friday.google_clients", "bigquery_get_table", "", None, None),
    ("friday.google_clients", "bigquery_insert_rows", "", None, None),
    ("friday.google_clients", "bigquery_list_datasets", "", None, None),
    ("friday.google_clients", "bigquery_list_tables", "", None, None),
    ("friday.google_clients", "books_add_to_bookshelf", "", None, None),
    ("friday.google_clients", "books_clear_bookshelf", "", None, None),
    ("friday.google_clients", "books_create_annotation", "", None, None),
    ("friday.google_clients", "books_delete_annotation", "", None, None),
    ("friday.google_clients", "books_get_bookshelf", "", None, None),
    ("friday.google_clients", "books_get_reading_position", "", None, None),
    ("friday.google_clients", "books_get_volume_annotations", "", None, None),
    ("friday.google_clients", "books_get_volume_recommended", "", None, None),
    ("friday.google_clients", "books_list_annotations", "Books List Annotations", {}, None),
    ("friday.google_clients", "books_list_bookshelves", "Books List Bookshelves", {}, None),
    ("friday.google_clients", "books_list_volumes", "", None, None),
    ("friday.google_clients", "books_move_volume", "", None, None),
    ("friday.google_clients", "books_remove_from_bookshelf", "", None, None),
    ("friday.google_clients", "books_search_by_subject", "", None, None),
    ("friday.google_clients", "books_set_reading_position", "", None, None),
    ("friday.google_clients", "calendar_delete_event", "", None, None),
    ("friday.google_clients", "calendar_freebusy", "", None, None),
    ("friday.google_clients", "calendar_get_colors", "Calendar Get Colors", {}, None),
    ("friday.google_clients", "calendar_get_event", "", None, None),
    ("friday.google_clients", "calendar_import_event", "", None, None),
    ("friday.google_clients", "calendar_list_acl", "", None, None),
    ("friday.google_clients", "calendar_list_colors", "Calendar List Colors", {}, None),
    ("friday.google_clients", "calendar_move_event", "", None, None),
    ("friday.google_clients", "calendar_quick_add", "", None, None),
    ("friday.google_clients", "calendar_set_reminder", "", None, None),
    ("friday.google_clients", "calendar_stop_watch", "", None, None),
    ("friday.google_clients", "calendar_update_event", "", None, None),
    ("friday.google_clients", "calendar_watch", "", None, None),
    ("friday.google_clients", "call_api", "", None, None),
    ("friday.google_clients", "configure_logging", "", None, None),
    ("friday.google_clients", "docs_create_positioned_image", "", None, None),
    ("friday.google_clients", "docs_delete_footer", "", None, None),
    ("friday.google_clients", "docs_delete_header", "", None, None),
    ("friday.google_clients", "docs_delete_table_row", "", None, None),
    ("friday.google_clients", "docs_get_document", "", None, None),
    ("friday.google_clients", "docs_insert_footer", "", None, None),
    ("friday.google_clients", "docs_insert_header", "", None, None),
    ("friday.google_clients", "docs_insert_page_break", "", None, None),
    ("friday.google_clients", "docs_insert_table", "", None, None),
    ("friday.google_clients", "docs_replace_all_text", "", None, None),
    ("friday.google_clients", "docs_update_document_title", "", None, None),
    ("friday.google_clients", "docs_update_paragraph_style", "", None, None),
    ("friday.google_clients", "docs_update_text_style", "", None, None),
    ("friday.google_clients", "drive_about", "Drive About", {}, None),
    ("friday.google_clients", "drive_add_label", "", None, None),
    ("friday.google_clients", "drive_copy", "", None, None),
    ("friday.google_clients", "drive_create_shortcut", "", None, None),
    ("friday.google_clients", "drive_empty_trash", "Drive Empty Trash", {}, None),
    ("friday.google_clients", "drive_generate_ids", "", None, None),
    ("friday.google_clients", "drive_list_labels", "", None, None),
    ("friday.google_clients", "drive_list_starred", "", None, None),
    ("friday.google_clients", "drive_move", "", None, None),
    ("friday.google_clients", "drive_trash", "", None, None),
    ("friday.google_clients", "drive_untrash", "", None, None),
    ("friday.google_clients", "drive_update", "", None, None),
    ("friday.google_clients", "drive_watch", "", None, None),
    ("friday.google_clients", "firestore_batch_get", "", None, None),
    ("friday.google_clients", "firestore_begin_transaction", "", None, None),
    ("friday.google_clients", "firestore_commit", "", None, None),
    ("friday.google_clients", "firestore_create_document", "", None, None),
    ("friday.google_clients", "firestore_list_collections", "", None, None),
    ("friday.google_clients", "firestore_list_documents", "", None, None),
    ("friday.google_clients", "firestore_rollback", "", None, None),
    ("friday.google_clients", "firestore_run_query", "", None, None),
    ("friday.google_clients", "firestore_update_document", "", None, None),
    ("friday.google_clients", "get_access_token", "Get Access Token", {}, None),
    ("friday.google_clients", "gmail_auto_forward", "", None, None),
    ("friday.google_clients", "gmail_batch_delete", "", None, None),
    ("friday.google_clients", "gmail_create_filter", "", None, None),
    ("friday.google_clients", "gmail_create_label", "", None, None),
    ("friday.google_clients", "gmail_delete_filter", "", None, None),
    ("friday.google_clients", "gmail_delete_label", "", None, None),
    ("friday.google_clients", "gmail_delete_message", "", None, None),
    ("friday.google_clients", "gmail_get_attachment", "", None, None),
    ("friday.google_clients", "gmail_get_auto_forwarding", "Gmail Get Auto Forwarding", {}, None),
    ("friday.google_clients", "gmail_get_delegated_accounts", "Gmail Get Delegated Accounts", {}, None),
    ("friday.google_clients", "gmail_get_message", "", None, None),
    ("friday.google_clients", "gmail_get_profile", "Gmail Get Profile", {}, None),
    ("friday.google_clients", "gmail_import_message", "", None, None),
    ("friday.google_clients", "gmail_list_drafts", "", None, None),
    ("friday.google_clients", "gmail_list_filters", "Gmail List Filters", {}, None),
    ("friday.google_clients", "gmail_list_labels", "Gmail List Labels", {}, None),
    ("friday.google_clients", "gmail_list_messages_paged", "", None, None),
    ("friday.google_clients", "gmail_modify_message", "", None, None),
    ("friday.google_clients", "gmail_read_draft", "", None, None),
    ("friday.google_clients", "gmail_search", "", None, None),
    ("friday.google_clients", "gmail_send_raw", "", None, None),
    ("friday.google_clients", "gmail_trash_message", "", None, None),
    ("friday.google_clients", "gmail_untrash_message", "", None, None),
    ("friday.google_clients", "gmail_update_label", "", None, None),
    ("friday.google_clients", "maps_autocomplete", "", None, None),
    ("friday.google_clients", "maps_distance_matrix", "", None, None),
    ("friday.google_clients", "maps_find_place", "", None, None),
    ("friday.google_clients", "maps_nearby_search", "", None, None),
    ("friday.google_clients", "maps_query_autocomplete", "", None, None),
    ("friday.google_clients", "maps_roads_nearest_roads", "", None, None),
    ("friday.google_clients", "maps_roads_snap_to_roads", "", None, None),
    ("friday.google_clients", "maps_text_search", "", None, None),
    ("friday.google_clients", "maps_timezone", "", None, None),
    ("friday.google_clients", "nlp_analyze_entity_sentiment", "", None, None),
    ("friday.google_clients", "people_copy_other_contact_to_my_contacts", "", None, None),
    ("friday.google_clients", "people_create_group", "", None, None),
    ("friday.google_clients", "people_delete_group", "", None, None),
    ("friday.google_clients", "people_get_batch_get", "", None, None),
    ("friday.google_clients", "people_list_connections", "", None, None),
    ("friday.google_clients", "people_list_contact_groups", "", None, None),
    ("friday.google_clients", "people_list_groups", "People List Groups", {}, None),
    ("friday.google_clients", "people_search_directory", "", None, None),
    ("friday.google_clients", "people_update_group", "", None, None),
    ("friday.google_clients", "photos_add_to_album", "", None, None),
    ("friday.google_clients", "photos_get_album", "", None, None),
    ("friday.google_clients", "photos_get_media_item_metadata", "", None, None),
    ("friday.google_clients", "photos_leave_shared_album", "", None, None),
    ("friday.google_clients", "photos_list_shared_albums", "", None, None),
    ("friday.google_clients", "photos_remove_from_album", "", None, None),
    ("friday.google_clients", "photos_search_by_content", "", None, None),
    ("friday.google_clients", "photos_share_album", "", None, None),
    ("friday.google_clients", "photos_unshare_album", "", None, None),
    ("friday.google_clients", "photos_upload", "", None, None),
    ("friday.google_clients", "searchconsole_crawl_errors_counts", "", None, None),
    ("friday.google_clients", "searchconsole_crawl_errors_samples", "", None, None),
    ("friday.google_clients", "searchconsole_inspect_url", "", None, None),
    ("friday.google_clients", "searchconsole_list_sitemaps", "", None, None),
    ("friday.google_clients", "searchconsole_mark_crawl_error_fixed", "", None, None),
    ("friday.google_clients", "searchconsole_remove_sitemap", "", None, None),
    ("friday.google_clients", "searchconsole_submit_sitemap", "", None, None),
    ("friday.google_clients", "searchconsole_test_robots_txt", "", None, None),
    ("friday.google_clients", "sheets_add_named_range", "", None, None),
    ("friday.google_clients", "sheets_add_sheet", "", None, None),
    ("friday.google_clients", "sheets_auto_resize", "", None, None),
    ("friday.google_clients", "sheets_clear", "", None, None),
    ("friday.google_clients", "sheets_create_chart", "", None, None),
    ("friday.google_clients", "sheets_delete_columns", "", None, None),
    ("friday.google_clients", "sheets_delete_named_range", "", None, None),
    ("friday.google_clients", "sheets_delete_rows", "", None, None),
    ("friday.google_clients", "sheets_delete_sheet", "", None, None),
    ("friday.google_clients", "sheets_duplicate_sheet", "", None, None),
    ("friday.google_clients", "sheets_find_replace", "", None, None),
    ("friday.google_clients", "sheets_format_range", "", None, None),
    ("friday.google_clients", "sheets_get_columns", "", None, None),
    ("friday.google_clients", "sheets_get_named_ranges", "", None, None),
    ("friday.google_clients", "sheets_insert_columns", "", None, None),
    ("friday.google_clients", "sheets_insert_rows", "", None, None),
    ("friday.google_clients", "sheets_merge_cells", "", None, None),
    ("friday.google_clients", "sheets_move_sheet", "", None, None),
    ("friday.google_clients", "sheets_protect_range", "", None, None),
    ("friday.google_clients", "sheets_set_data_validation", "", None, None),
    ("friday.google_clients", "sheets_unmerge_cells", "", None, None),
    ("friday.google_clients", "sheets_update_cell", "", None, None),
    ("friday.google_clients", "slides_add_video", "", None, None),
    ("friday.google_clients", "slides_add_word_art", "", None, None),
    ("friday.google_clients", "slides_delete_slide", "", None, None),
    ("friday.google_clients", "slides_duplicate_slide", "", None, None),
    ("friday.google_clients", "slides_get_page_thumbnails", "", None, None),
    ("friday.google_clients", "slides_group_objects", "", None, None),
    ("friday.google_clients", "slides_insert_line", "", None, None),
    ("friday.google_clients", "slides_insert_shape", "", None, None),
    ("friday.google_clients", "slides_insert_table", "", None, None),
    ("friday.google_clients", "slides_list", "", None, None),
    ("friday.google_clients", "slides_move_slide", "", None, None),
    ("friday.google_clients", "slides_refresh_presentation", "", None, None),
    ("friday.google_clients", "slides_update_page_element_transform", "", None, None),
    ("friday.google_clients", "slides_update_slide_background", "", None, None),
    ("friday.google_clients", "slides_update_text", "", None, None),
    ("friday.google_clients", "storage_copy_file", "", None, None),
    ("friday.google_clients", "storage_create_bucket", "", None, None),
    ("friday.google_clients", "storage_delete_bucket", "", None, None),
    ("friday.google_clients", "storage_delete_file", "", None, None),
    ("friday.google_clients", "storage_get_file", "", None, None),
    ("friday.google_clients", "storage_list_buckets", "", None, None),
    ("friday.google_clients", "storage_move_file", "", None, None),
    ("friday.google_clients", "tasks_clear_completed", "", None, None),
    ("friday.google_clients", "tasks_create_tasklist", "", None, None),
    ("friday.google_clients", "tasks_delete_tasklist", "", None, None),
    ("friday.google_clients", "tasks_get", "", None, None),
    ("friday.google_clients", "tasks_move", "", None, None),
    ("friday.google_clients", "tasks_update_tasklist", "", None, None),
    ("friday.google_clients", "translate_batch_translate", "", None, None),
    ("friday.google_clients", "translate_get_supported_glossaries", "Translate Get Supported Glossaries", {}, None),
    ("friday.google_clients", "translate_list_languages", "", None, None),
    ("friday.google_clients", "tts_list_voices", "", None, None),
    ("friday.google_clients", "tts_synthesize_long_audio", "", None, None),
    ("friday.google_clients", "vision_async_batch_annotate", "", None, None),
    ("friday.google_clients", "vision_detect_crop_hints", "", None, None),
    ("friday.google_clients", "vision_detect_document", "", None, None),
    ("friday.google_clients", "vision_detect_faces", "", None, None),
    ("friday.google_clients", "vision_detect_image_properties", "", None, None),
    ("friday.google_clients", "vision_detect_labels", "", None, None),
    ("friday.google_clients", "vision_detect_landmarks", "", None, None),
    ("friday.google_clients", "vision_detect_logos", "", None, None),
    ("friday.google_clients", "vision_detect_objects", "", None, None),
    ("friday.google_clients", "vision_detect_safe_search", "", None, None),
    ("friday.google_clients", "vision_detect_text", "", None, None),
    ("friday.google_clients", "vision_detect_text_full", "", None, None),
    ("friday.google_clients", "vision_detect_web", "", None, None),
    ("friday.google_clients", "youtube_add_video_to_playlist", "", None, None),
    ("friday.google_clients", "youtube_bind_broadcast", "", None, None),
    ("friday.google_clients", "youtube_channel_search", "", None, None),
    ("friday.google_clients", "youtube_create_broadcast", "", None, None),
    ("friday.google_clients", "youtube_create_playlist", "", None, None),
    ("friday.google_clients", "youtube_create_stream", "", None, None),
    ("friday.google_clients", "youtube_delete_playlist", "", None, None),
    ("friday.google_clients", "youtube_delete_video", "", None, None),
    ("friday.google_clients", "youtube_download_caption", "", None, None),
    ("friday.google_clients", "youtube_get_captions", "", None, None),
    ("friday.google_clients", "youtube_get_channel_analytics", "", None, None),
    ("friday.google_clients", "youtube_get_channel_sections", "", None, None),
    ("friday.google_clients", "youtube_get_trascript", "", None, None),
    ("friday.google_clients", "youtube_get_video_categories", "", None, None),
    ("friday.google_clients", "youtube_get_video_rating", "", None, None),
    ("friday.google_clients", "youtube_list_my_videos", "", None, None),
    ("friday.google_clients", "youtube_list_playlists", "", None, None),
    ("friday.google_clients", "youtube_list_replies", "", None, None),
    ("friday.google_clients", "youtube_list_subscriptions", "", None, None),
    ("friday.google_clients", "youtube_moderate_comment", "", None, None),
    ("friday.google_clients", "youtube_rate_video", "", None, None),
    ("friday.google_clients", "youtube_remove_video_from_playlist", "", None, None),
    ("friday.google_clients", "youtube_reply_to_comment", "", None, None),
    ("friday.google_clients", "youtube_report_abuse", "", None, None),
    ("friday.google_clients", "youtube_search_channels", "", None, None),
    ("friday.google_clients", "youtube_set_thumbnail", "", None, None),
    ("friday.google_clients", "youtube_subscribe", "", None, None),
    ("friday.google_clients", "youtube_transition_broadcast", "", None, None),
    ("friday.google_clients", "youtube_unsubscribe", "", None, None),
    ("friday.google_clients", "youtube_update_playlist", "", None, None),
    ("friday.google_clients", "youtube_update_video", "", None, None),
    ("friday.google_clients", "youtube_upload_video", "", None, None),
    ("friday.google_clients", "maps_open_directions", "Open Google Maps with free directions (no API key). Supports home/work from memory, stops, ETA via OSRM.", {
                "origin": {
                                "type": "STRING",
                                "description": "Starting address, lat,lng, or 'home'/'work'"
                },
                "destination": {
                                "type": "STRING",
                                "description": "Destination address, lat,lng, or 'home'/'work'"
                },
                "waypoints": {
                                "type": "ARRAY",
                                "items": {
                                ...
                                "description": "Optional list of stop addresses"
                },
                "travelmode": {
                                "type": "STRING",
                ...
                "origin_name": {
                                "type": "STRING",
                                "description": "Optional origin display name"
                },
                "destination_name": {
                                "type": "STRING",
                                "description": "Optional destination display name"
                }
}, ["origin", "destination"]),
    ("friday.google_clients", "maps_geocode_free", "Free geocoding via OpenStreetMap Nominatim. No API key needed.", {
                "address": {
                                "type": "STRING",
                                "description": "Address to geocode"
                }
}, ["address"]),
    ("friday.google_clients", "maps_get_eta", "Get ETA and distance via free OSRM routing. No API key needed.", {
                "origin_lat": {
                                "type": "NUMBER",
                ...
                "waypoints": {
                                ...
                                "description": "Optional list of {lat, lng} waypoints"
                }
}, ["origin_lat", "origin_lng", "dest_lat", "dest_lng"]),

    # ── Desktop-Use Bridge (native Windows app control) ──
    ("friday.desktop_use_bridge", "desktop_use_status", "Check if desktop control is available.", None, None),
    ("friday.desktop_use_bridge", "desktop_list_windows", "List all open windows with titles, class names, and handles.", None, None),
    ("friday.desktop_use_bridge", "desktop_get_active_window", "Get the title of the currently active (foreground) window.", None, None),
    ("friday.desktop_use_bridge", "desktop_focus_window", "Bring a window to the foreground by title.", {"title": {"type": "STRING", "description": "Window title or substring"}}, ["title"]),
    ("friday.desktop_use_bridge", "desktop_launch_app", "Launch a desktop application by path or executable name.", {"path": {"type": "STRING", "description": "App path or exe name (e.g. notepad.exe, calc.exe)"}}, ["path"]),
    ("friday.desktop_use_bridge", "desktop_click", "Click on an element by title, auto_id, or class_name.", {"text": {"type": "STRING", "description": "Title text to click"}, "auto_id": {"type": "STRING", "description": "UIA automation ID"}, "class_name": {"type": "STRING", "description": "Class name"}, "title": {"type": "STRING", "description": "Focus window by title"}}, None),
    ("friday.desktop_use_bridge", "desktop_type_text", "Type text into the currently focused window or a specific window.", {"text": {"type": "STRING", "description": "Text to type"}, "window_title": {"type": "STRING", "description": "Target window title (optional)"}}, ["text"]),
    ("friday.desktop_use_bridge", "desktop_extract_text", "Get window titles and class names for visible windows.", {"window_title": {"type": "STRING", "description": "Filter by window title (optional)"}}, None),
    ("friday.desktop_use_bridge", "desktop_screenshot", "Take a full-screen screenshot (returns base64 PNG).", None, None),
    ("friday.desktop_use_bridge", "desktop_scroll", "Scroll the mouse wheel up or down.", {"direction": {"type": "STRING", "description": "down or up (default down)"}, "clicks": {"type": "INTEGER", "description": "Number of scroll clicks (default 3)"}}, None),
    ("friday.desktop_use_bridge", "desktop_press_key", "Send a keyboard key press (e.g. {ENTER}, {TAB}, ^C for Ctrl+C).", {"key": {"type": "STRING", "description": "Key to press (pywinauto format: {ENTER}, {TAB}, ^C, etc)"}}, ["key"]),
    ("friday.desktop_use_bridge", "desktop_get_element_tree", "Get the full UIA element tree of a window for UI structure inspection.", {"window_title": {"type": "STRING", "description": "Window title or substring"}}, ["window_title"]),

    # ── Voice-Use Bridge (voice I/O: record, transcribe, TTS, play) ──
    ("friday.voice_use_bridge", "voice_use_status", "Check voice I/O availability and backend status.", None, None),
    ("friday.voice_use_bridge", "voice_list_devices", "List all audio input/output devices.", None, None),
    ("friday.voice_use_bridge", "voice_record", "Record audio from microphone for a given duration.", {"duration": {"type": "NUMBER", "description": "Recording duration in seconds (default 5)"}, "samplerate": {"type": "INTEGER", "description": "Sample rate (default 16000)"}}, None),
    ("friday.voice_use_bridge", "voice_transcribe", "Transcribe an audio file to text using Whisper or Groq.", {"audio_path": {"type": "STRING", "description": "Path to audio file"}, "engine": {"type": "STRING", "description": "Transcription engine: whisper or groq (default whisper)"}}, ["audio_path"]),
    ("friday.voice_use_bridge", "voice_record_and_transcribe", "Record audio and transcribe it in one step.", {"duration": {"type": "NUMBER", "description": "Recording duration in seconds (default 5)"}, "engine": {"type": "STRING", "description": "Transcription engine: whisper or groq"}}, None),
    ("friday.voice_use_bridge", "voice_speak", "Convert text to speech and play it aloud.", {"text": {"type": "STRING", "description": "Text to speak"}, "engine": {"type": "STRING", "description": "TTS engine: gtts, edge, or pyttsx3 (default gtts)"}, "lang": {"type": "STRING", "description": "Language code (default en)"}}, ["text"]),
    ("friday.voice_use_bridge", "voice_play", "Play an audio file through speakers.", {"audio_path": {"type": "STRING", "description": "Path to audio file"}}, ["audio_path"]),
    ("friday.voice_use_bridge", "voice_detect_wake_word", "Initialize wake word detection (Porcupine).", {"keyword": {"type": "STRING", "description": "Wake word (default computer)"}, "sensitivity": {"type": "NUMBER", "description": "Detection sensitivity 0-1 (default 0.5)"}}, None),
    ("friday.voice_use_bridge", "voice_analyze", "Analyze audio file for tempo, spectral features, RMS.", {"audio_path": {"type": "STRING", "description": "Path to audio file"}}, ["audio_path"]),

    # ── Agent-Use Bridge (multi-agent orchestration) ──
    ("friday.agent_use_bridge", "agent_use_status", "Check multi-agent system health and active agents.", None, None),
    ("friday.agent_use_bridge", "agent_use_list_agents", "List all available agent profiles with descriptions.", None, None),
    ("friday.agent_use_bridge", "agent_use_spawn", "Spawn a new agent with terminal window for a task.", {"name": {"type": "STRING", "description": "Agent name"}, "task": {"type": "STRING", "description": "Task description"}, "role": {"type": "STRING", "description": "Agent role (veronica, forge, ghost, atlas, jarvis, etc)"}}, ["name", "task"]),
    ("friday.agent_use_bridge", "agent_use_delegate", "Delegate a task to the best-matching agent.", {"task_description": {"type": "STRING", "description": "Task description"}, "role": {"type": "STRING", "description": "Optional: force specific agent role"}}, ["task_description"]),
    ("friday.agent_use_bridge", "agent_use_workflow", "Run a complete multi-step workflow (research -> analyze -> produce result).", {"task_description": {"type": "STRING", "description": "Task description for the full workflow"}}, ["task_description"]),
    ("friday.agent_use_bridge", "agent_use_kill", "Kill a running agent by name.", {"name": {"type": "STRING", "description": "Agent name to kill"}}, ["name"]),
    ("friday.agent_use_bridge", "agent_use_heartbeats", "Get all current agent heartbeats (status, role, action).", None, None),

    # ── Security-Use Bridge (unified security & pen-testing toolkit) ──
    ("friday.security_use_bridge", "security_use_status", "Check security toolkit availability and backends.", None, None),
    ("friday.security_use_bridge", "wifi_list_profiles", "List saved WiFi profiles on Windows.", None, None),
    ("friday.security_use_bridge", "wifi_show_password", "Show WiFi password for a saved profile (requires admin).", {"ssid": {"type": "STRING", "description": "SSID of saved profile"}}, ["ssid"]),
    ("friday.security_use_bridge", "wifi_scan", "Scan for nearby WiFi networks (SSID, auth, encryption, signal, channel).", None, None),
    ("friday.security_use_bridge", "wifi_connection_status", "Get current WiFi connection status (SSID, signal, auth, radio).", None, None),
    ("friday.security_use_bridge", "network_connections", "List active TCP/UDP network connections (netstat -ano).", None, None),
    ("friday.security_use_bridge", "arp_table", "Get ARP table — IP to MAC mappings on local network.", None, None),
    ("friday.security_use_bridge", "traceroute", "Trace network route to a target host.", {"target": {"type": "STRING", "description": "Target hostname or IP"}, "max_hops": {"type": "INTEGER", "description": "Max hops (default 30)"}}, ["target"]),
    ("friday.security_use_bridge", "dns_lookup", "Look up DNS records (A, AAAA, MX, NS, TXT, CNAME, SOA) for a domain.", {"domain": {"type": "STRING", "description": "Domain to query"}, "record_types": {"type": "STRING", "description": "Comma-separated record types (default A,AAAA,MX,NS,TXT)"}}, ["domain"]),
    ("friday.security_use_bridge", "dns_reverse_lookup", "Reverse DNS lookup — find hostname for an IP address.", {"ip": {"type": "STRING", "description": "IP address"}}, ["ip"]),
    ("friday.security_use_bridge", "dns_mx_lookup", "Get MX records (mail servers) for a domain.", {"domain": {"type": "STRING", "description": "Domain to query"}}, ["domain"]),
    ("friday.security_use_bridge", "dns_enumeration", "Enumerate subdomains via common wordlist and DNS resolution.", {"domain": {"type": "STRING", "description": "Domain to enumerate"}, "aggressive": {"type": "BOOLEAN", "description": "Use larger wordlist (default false)"}}, ["domain"]),
    ("friday.security_use_bridge", "port_scan", "Scan TCP ports on a host to find open services.", {"host": {"type": "STRING", "description": "Target hostname or IP"}, "ports": {"type": "STRING", "description": "Comma-separated ports (default common ports)"}}, ["host"]),
    ("friday.security_use_bridge", "ping_host", "Ping a host to check if it is reachable.", {"host": {"type": "STRING", "description": "Hostname or IP"}, "count": {"type": "INTEGER", "description": "Ping count (default 3)"}}, ["host"]),
    ("friday.security_use_bridge", "ssl_certificate_check", "Check SSL/TLS certificate details for a hostname.", {"hostname": {"type": "STRING", "description": "Hostname to check"}, "port": {"type": "INTEGER", "description": "Port (default 443)"}}, ["hostname"]),
    ("friday.security_use_bridge", "shodan_search", "Search Shodan for internet-connected devices matching a query.", {"query": {"type": "STRING", "description": "Shodan search query"}, "limit": {"type": "INTEGER", "description": "Max results (default 10)"}}, ["query"]),
    ("friday.security_use_bridge", "shodan_host", "Get detailed Shodan information for a specific IP address.", {"ip": {"type": "STRING", "description": "IP address"}}, ["ip"]),
    ("friday.security_use_bridge", "shodan_search_count", "Get Shodan search result count without retrieving details.", {"query": {"type": "STRING", "description": "Shodan search query"}}, ["query"]),
    ("friday.security_use_bridge", "shodan_ports", "Get open ports for an IP from Shodan.", {"ip": {"type": "STRING", "description": "IP address"}}, ["ip"]),
    ("friday.security_use_bridge", "whois_lookup", "Look up WHOIS registration data for a domain.", {"domain": {"type": "STRING", "description": "Domain to look up"}}, ["domain"]),
    ("friday.security_use_bridge", "geoip_lookup", "Get geographic location data for an IP address.", {"ip": {"type": "STRING", "description": "IP address"}}, ["ip"]),
    ("friday.security_use_bridge", "hibp_breach_check", "Check if an email appears in known data breaches (Have I Been Pwned).", {"email": {"type": "STRING", "description": "Email to check"}}, ["email"]),

    # ── Memory-Use Bridge (unified memory, learning & knowledge graph toolkit) ──
    ("friday.memory_use_bridge", "memory_use_status", "Check memory/learning toolkit availability and backends.", None, None),
    ("friday.memory_use_bridge", "chroma_create_collection", "Create a new ChromaDB collection for vector storage.", {"name": {"type": "STRING", "description": "Collection name"}}, ["name"]),
    ("friday.memory_use_bridge", "chroma_add", "Add documents with metadata to a ChromaDB collection.", {"collection": {"type": "STRING", "description": "Collection name"}, "texts": {"type": "ARRAY", "items": {"type": "STRING"}, "description": "Document texts"}, "ids": {"type": "ARRAY", "items": {"type": "STRING"}, "description": "Unique IDs"}, "metadatas": {"type": "ARRAY", "items": {"type": "OBJECT"}, "description": "Optional metadata per document"}}, ["collection", "texts", "ids"]),
    ("friday.memory_use_bridge", "chroma_query", "Search a ChromaDB collection by semantic similarity.", {"collection": {"type": "STRING", "description": "Collection name"}, "query_text": {"type": "STRING", "description": "Search query"}, "n_results": {"type": "INTEGER", "description": "Max results (default 5)"}}, ["collection", "query_text"]),
    ("friday.memory_use_bridge", "chroma_list_collections", "List all ChromaDB collections.", None, None),
    ("friday.memory_use_bridge", "redis_set", "Set a key-value pair in Redis with optional TTL.", {"key": {"type": "STRING", "description": "Key name"}, "value": {"type": "STRING", "description": "Value"}, "ttl": {"type": "INTEGER", "description": "TTL in seconds (optional)"}}, ["key", "value"]),
    ("friday.memory_use_bridge", "redis_get", "Get a value from Redis by key.", {"key": {"type": "STRING", "description": "Key name"}}, ["key"]),
    ("friday.memory_use_bridge", "redis_delete", "Delete a key from Redis.", {"key": {"type": "STRING", "description": "Key name"}}, ["key"]),
    ("friday.memory_use_bridge", "redis_list_keys", "List Redis keys matching a pattern.", {"pattern": {"type": "STRING", "description": "Key pattern (default *)"}}, None),
    ("friday.memory_use_bridge", "neo4j_run_query", "Run a Cypher query on Neo4j knowledge graph.", {"query": {"type": "STRING", "description": "Cypher query"}, "params": {"type": "OBJECT", "description": "Query parameters (optional)"}}, ["query"]),
    ("friday.memory_use_bridge", "neo4j_create_entity", "Create a new entity node in Neo4j knowledge graph.", {"label": {"type": "STRING", "description": "Entity label"}, "properties": {"type": "OBJECT", "description": "Entity properties"}}, ["label", "properties"]),
    ("friday.memory_use_bridge", "neo4j_find_entities", "Find entity nodes by label in Neo4j.", {"label": {"type": "STRING", "description": "Entity label"}, "limit": {"type": "INTEGER", "description": "Max results (default 50)"}}, ["label"]),
    ("friday.memory_use_bridge", "vm_add", "Add text to vector memory for semantic recall.", {"text": {"type": "STRING", "description": "Text to remember"}, "metadata": {"type": "OBJECT", "description": "Optional metadata"}, "id": {"type": "STRING", "description": "Optional ID"}}, ["text"]),
    ("friday.memory_use_bridge", "vm_search", "Search vector memory for semantically similar content.", {"query": {"type": "STRING", "description": "Search query"}, "n_results": {"type": "INTEGER", "description": "Max results (default 5)"}}, ["query"]),
    ("friday.memory_use_bridge", "vm_stats", "Get vector memory statistics (document count, etc).", None, None),
    ("friday.memory_use_bridge", "vm_delete", "Delete a document from vector memory by ID.", {"id": {"type": "STRING", "description": "Document ID"}}, ["id"]),
    ("friday.memory_use_bridge", "vm_clear", "Clear all documents from vector memory.", None, None),
    ("friday.memory_use_bridge", "kyu_status", "Check KYU preference learning engine status.", None, None),
    ("friday.memory_use_bridge", "kyu_interview", "Run KYU preference interview to learn user preferences.", {"stage": {"type": "INTEGER", "description": "Interview stage (optional)"}}, None),
    ("friday.memory_use_bridge", "kyu_learn", "Submit a learning signal to KYU (tool used, window title, hour).", {"tool_name": {"type": "STRING", "description": "Tool name (optional)"}, "active_window": {"type": "STRING", "description": "Active window title (optional)"}, "hour": {"type": "INTEGER", "description": "Hour of day 0-23 (optional)"}}, None),
    ("friday.memory_use_bridge", "kyu_profile", "Get KYU user preference profile.", None, None),
    ...
    ("friday.tools.nvidia_tools", "nvidia_list_models", "List available NVIDIA NIM free AI models (image gen, chat).", None, None),
    ("friday.tools.nvidia_tools", "nvidia_image_gen", "Generate an image using NVIDIA NIM free API. Requires NVIDIA_API_KEY env var.", {"prompt": {"type": "STRING", "description": "Image description"}, "model": {"type": "STRING", "description": "Model: flux.1-schnell, sdxl, stable-diffusion-3.5-medium, playground-v2.5 (default flux.1-schnell)"}, "output_path": {"type": "STRING", "description": "Custom output path (optional)"}}, ["prompt"]),
    ("friday.tools.nvidia_tools", "nvidia_chat", "Chat with a free NVIDIA NIM LLM model (Llama, Mixtral, Nemotron, DeepSeek).", {"prompt": {"type": "STRING", "description": "User prompt"}, "model": {"type": "STRING", "description": "Model path (default meta/llama-3.3-70b-instruct)"}, "system_prompt": {"type": "STRING", "description": "System prompt (optional)"}, "max_tokens": {"type": "INTEGER", "description": "Max tokens (default 1024)"}}, ["prompt"]),
    ("friday.tools.nvidia_tools", "nvidia_status", "Check NVIDIA NIM API connectivity and configuration.", None, None),

    # ── Artifact Tools (interactive HTML content creation — websites, games, SVGs, animations, documents) ──
    ("friday.tools.artifact_tools", "artifact_create_website", "Create a standalone HTML website artifact with custom HTML/CSS/JS and open in browser.", {"html_content": {"type": "STRING", "description": "HTML content for the body"}, "title": {"type": "STRING", "description": "Page title (default Untitled)"}, "css_content": {"type": "STRING", "description": "CSS styles (optional)"}, "js_content": {"type": "STRING", "description": "JavaScript code (optional)"}}, ["html_content"]),
    ("friday.tools.artifact_tools", "artifact_create_game", "Generate a complete playable HTML5 game of the specified genre.", {"description": {"type": "STRING", "description": "Optional game description/customization"}, "genre": {"type": "STRING", "description": "Genre: puzzle, snake, breakout, tetris, trivia (default puzzle)"}}, None),
    ("friday.tools.artifact_tools", "artifact_create_svg", "Create an SVG graphic artifact and open in browser.", {"svg_content": {"type": "STRING", "description": "SVG markup content"}, "title": {"type": "STRING", "description": "Title (default SVG Graphic)"}}, ["svg_content"]),
    ("friday.tools.artifact_tools", "artifact_create_animation", "Create interactive HTML5 Canvas animation (particles, fireworks, waves, boids, charts).", {"animation_type": {"type": "STRING", "description": "Type: particles, fireworks, stars, waves, clock, fractal, boids, bar_chart, line_chart, pie_chart (default particles)"}, "config_json": {"type": "STRING", "description": "JSON config string (optional)"}}, None),
    ("friday.tools.artifact_tools", "artifact_create_document", "Create a formatted document (markdown/HTML/plain text) as an artifact.", {"content": {"type": "STRING", "description": "Document content"}, "format": {"type": "STRING", "description": "Format: markdown, html, plain (default markdown)"}, "title": {"type": "STRING", "description": "Document title (default Document)"}}, ["content"]),
    ("friday.tools.artifact_tools", "artifact_list", "List all created artifacts.", {"limit": {"type": "INTEGER", "description": "Max results (default 20)"}}, None),
    ("friday.tools.artifact_tools", "artifact_open", "Open a specific artifact in browser.", {"artifact_id": {"type": "STRING", "description": "Artifact ID to open"}}, ["artifact_id"]),
    ("friday.tools.artifact_tools", "artifact_delete", "Delete a specific artifact.", {"artifact_id": {"type": "STRING", "description": "Artifact ID to delete"}}, ["artifact_id"]),

    # ── Presentation Tools (PowerPoint PPTX + HTML slide decks) ──
    ("friday.tools.presentation_tools", "presentation_create", "Create a presentation from JSON slide descriptions (PPXT or HTML format).", {"slides_json": {"type": "STRING", "description": "JSON array of slide objects"}, "title": {"type": "STRING", "description": "Presentation title (default Presentation)"}, "format": {"type": "STRING", "description": "Output format: pptx, html (default pptx)"}}, ["slides_json"]),
    ("friday.tools.presentation_tools", "presentation_create_from_markdown", "Create a presentation from markdown text (split by headings or ---).", {"markdown_text": {"type": "STRING", "description": "Markdown content"}, "title": {"type": "STRING", "description": "Presentation title (default Presentation)"}, "format": {"type": "STRING", "description": "Output format: html (default html)"}}, ["markdown_text"]),
    ("friday.tools.presentation_tools", "presentation_create_demo", "Create a demo presentation about any topic.", {"topic": {"type": "STRING", "description": "Presentation topic (default FRIDAY AI Assistant)"}, "slides": {"type": "INTEGER", "description": "Number of slides (default 8)"}}, None),
    ("friday.tools.presentation_tools", "presentation_list", "List all generated presentations.", {"limit": {"type": "INTEGER", "description": "Max results (default 20)"}}, None),
    ("friday.tools.presentation_tools", "presentation_open", "Open a presentation by filename.", {"presentation_id": {"type": "STRING", "description": "Presentation filename"}}, ["presentation_id"]),

    # ── Higgsfield AI Video Generation Tools ──
    ("friday.tools.higgsfield_tools", "higgsfield_generate_video", "Generate AI video from text prompt using Higgsfield API.", {"prompt": {"type": "STRING", "description": "Video description"}, "duration": {"type": "INTEGER", "description": "Duration in seconds 5-15 (default 10)"}, "resolution": {"type": "STRING", "description": "Resolution: 480p, 720p, 1080p (default 480p)"}, "model": {"type": "STRING", "description": "Model: higgsfield_v1 (default)"}, "api_key": {"type": "STRING", "description": "Higgsfield API key (optional, will check HIGGSFIELD_API_KEY env)"}}, ["prompt"]),
    ("friday.tools.higgsfield_tools", "higgsfield_generate_from_image", "Create a video from a static image with motion preset.", {"image_path": {"type": "STRING", "description": "Path to source image"}, "prompt": {"type": "STRING", "description": "Optional text prompt"}, "motion": {"type": "STRING", "description": "Motion preset: orbit, zoom_in, zoom_out, pan_left, pan_right, pan_up, pan_down, subtle (default orbit)"}}, ["image_path"]),
