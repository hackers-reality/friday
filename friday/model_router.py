...
PRESET_MODELS: Dict[str, ModelInfo] = {
    ...
    "nvidia/nim-vision": ModelInfo(
        ...
        capabilities=["vision", "scene_understanding", "object_detection"],
        max_output_tokens=4096,
    ),
    "nvidia/nim-vision-florence": ModelInfo(
    ...
    "nvidia/nemotron-nano-12b-v2-vl": ModelInfo(
        ...
        cost_per_1k_output=0.0,
        context_window=128_000,
        capabilities=["vision", "scene_understanding", "object_detection", "video_understanding"],
        max_output_tokens=4096,
    ),
    "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning": ModelInfo(
